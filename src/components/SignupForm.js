...
const SignupForm = () => {
    ...
    const handleRegister = () => {
        ...
        console.log(username, password, hint);
        navigate('/sucess');
        ...
        <div>
            <div className="content-box">
                <div className="button_sign_up">
                    ...
                    <input type="text" placeholder="Email Address" value={username} onChange={handleUsernameChange} />
                    {isEmailValid === false && (
                    ...
                    <div className='info'>
                        ...
                        <h5>Contains uppercase letters, lowercase letters, and special characters</h5>
